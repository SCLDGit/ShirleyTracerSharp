...
using InOneWeekend.Constants;
using InOneWeekend.DataTypes.Camera;
...
namespace InOneWeekend
{
    ...
    {
        private static Color GetColor(Ray p_ray, World p_world, int p_depth)
        {
            var maxDepth = 50;
        ...
        static void Main(string[] p_args)
        {
            ...
            var newWorld = new World(SceneGenerator.GenerateRandomScene(500));
